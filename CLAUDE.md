...
Issues and PRDs live on GitHub Issues (`gh` CLI) for `reddb-io/dit`. See `.red/agents/issue-tracker.md`.

### Triage labels

Canonical RedSkills triage vocabulary (`needs-triage`, `ready-for-agent`, `ready-for-human`, `blocked:*`, …). See `.red/agents/triage-labels.md`.
